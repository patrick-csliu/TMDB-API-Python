...
class TestMovies:
    ...
    def test_param_error(self):
        with pytest.raises(KeyError):
            tmdbapi.api3.discover.movies(wrong_name="True",
                                         include_adult=False,
                                         include_video=False,
                                         language="en-US",
                                         page=1,
    ...
    def test_1(self):
        tmdbapi.api3.discover.movies({'vote_average.gte': 3, 'vote_average.lte': 5},
                                     include_adult=False,
                                     include_video=False,
                                     language="en-US",
                                     page=1,
...
class TestTv:
    ...
    def test_param_error(self):
        with pytest.raises(KeyError):
            tmdbapi.api3.discover.tv(wrong_name="True",
                                     include_adult=False,
                                     include_video=False,
                                     language="en-US",
                                     page=1,
    ...
    def test_1(self):
        tmdbapi.api3.discover.tv({'vote_average.gte': 3, 'vote_average.lte': 5},
                                 include_adult=False,
                                 language="en-US",
                                 page=1,
