...
def test_create():
    json = tmdbapi.api4.lists.create("Test List", "This is a list for test (v4)", False, "primary_release_date.asc", "zh-TW", "TW")
...
def test_item_status():
    list_id = DataSharing.id
    tmdbapi.api4.lists.item_status(list_id, ITEMS1[1]["media_id"], ITEMS1[1]["media_type"])
...
def test_update():
    list_id = DataSharing.id
    tmdbapi.api4.lists.update(list_id, "Test List 2", "This is a list for test (v4)2", False, "title.desc", "en-US", "U")
